...
3. [Security for Android phone](https://github.com/NeverWonderLand/Self-Way/blob/main/Guide/Power_of_Anonimity.md#security-for-android-phone)
...
4. [Social Media](https://github.com/NeverWonderLand/Self-Way/blob/main/Guide/SEC_Legion.md#social-media)
5. [Browsing](https://github.com/NeverWonderLand/Self-Way/blob/main/Guide/SEC_Legion.md#browsing)
6. [VPN (Virtual Private Network)](https://github.com/NeverWonderLand/Self-Way/blob/main/Guide/SEC_Legion.md#vpn-virtual-private-network)
7. [VM (Virtual Machine)](https://github.com/NeverWonderLand/Self-Way/blob/main/Guide/SEC_Legion.md#vm-virtual-machine)
8. [Encryption](https://github.com/NeverWonderLand/Self-Way/blob/main/Guide/SEC_Legion.md#encryption)
9. [Proxy](https://github.com/NeverWonderLand/Self-Way/blob/main/Guide/SEC_Legion.md#proxy)
10. [VPS (Virtual Private Server)](https://github.com/NeverWonderLand/Self-Way/blob/main/Guide/SEC_Legion.md#vps-virtual-private-server)
11. [Cryptocurrency](https://github.com/NeverWonderLand/Self-Way/blob/main/Guide/SEC_Legion.md#cryptocurrency)
12. [Utilities](https://github.com/NeverWonderLand/Self-Way/blob/main/Guide/SEC_Legion.md#utilities)
